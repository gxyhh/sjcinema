SET NAMES UTF8;
DROP DATABASE IF EXISTS sjcinema;
CREATE DATABASE sjcinema DEFAULT CHARSET=UTF8;
USE sjcinema;
...
INSERT INTO movie_cinema_room_type VALUES 
(NULL, '杜比全景厅'),
(NULL, '巨幕厅'),
(NULL, '60帧厅'),
(NULL, '4k厅');
...
`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
`movie_cinema_id` int(11) NOT NULL COMMENT '外键字段，关联movie_cinema表的主键',
...
INSERT INTO movie_cinema_tag VALUES 
(NULL, '退'),
(NULL, '改签'),
(NULL, '4k厅');
...
`showingon_date` varchar(255) NULL COMMENT '上映时间（datetime类型）',
...
INSERT INTO admin1 (username,password,nickname,phone,email) VALUES('admin',MD5('123456'),'administrator','13212345678','13212345678@13.com')